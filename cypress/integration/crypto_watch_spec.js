...
it('Should be able to click into the crypto section and be taken to cryptocurrencies page', () => {
...
it('Should be able to click into the exchanges section and be taken to the exchanges page', () => {
    cy.get('.buySection')
    .click()
    .location('pathname')
    .should('eq', '/exchanges')
...
it("Should be able to click into the new to crypto section and be taken to crypto 101 page", () => {
  cy.get(".beginnerSection")
    .click()
    .location("pathname")
...
describe("Cryptocurrencies", () => {
  ...
  it("should see a subheading on the cryptocurrencies page", () => {
    cy.get(".cryptoTableHeading").should(
      "contain",
...
xdescribe("CryptocurrencyDetails", () => {
  ...
  it("should be able to click into a cryptocurrency name and be taken to a details page", () => {
    cy.get(".curiousSection").click().get("#btc-bitcoin").click();
  });
...
xdescribe("Loading", () => {
  ...
  it("should contain a loading message on Cryptocurrency page", () => {
    cy.get(".curiousSection").click().get(".loading").should("be.visible");
  });
  ...
  it("should contain a loading message on Exchange page", () => {
    cy.get(".buySection").click().get(".loading").should("be.visible");
  });

  it("should contain a loading message on Cryptopedia page", () => {
    cy.get(".beginnerSection").click().get(".loading").should("be.visible");
  });
});
...
xdescribe("Cryptopedia", () => {
  beforeEach(() => {
    ...
    cy.fixture("testCryptopediaData.json").then((cryptoData) => {
      cy.intercept("GET", "https://api.coinpaprika.com/v1/tags").as(
        "cryptopedia"
      );
    });
    cy.visit(baseURL);
